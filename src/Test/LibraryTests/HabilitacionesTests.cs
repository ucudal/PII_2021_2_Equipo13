...
namespace TestLibrary
{
    ...
    public class TestHabilitaciones
    {
        ...
        {
            Habilitacion h1 = new Habilitacion("Habilitacion Comercial", "Habilitacion Comercial", "Intendencia Municipal De Montevideo (IMM)", new DateTime(2021, 7, 10), new DateTime(2026, 9, 20), true);
