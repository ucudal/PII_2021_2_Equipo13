...
namespace ClassLibrary
{
    ...
    /// Sistema puede tener otros motivos para ser modificada.
    /// Se aplica el patrón Singleton dentro de esta clase para permitir solo la creación y utilización de una
    /// instancia de Buscador.
    /// </summary>
