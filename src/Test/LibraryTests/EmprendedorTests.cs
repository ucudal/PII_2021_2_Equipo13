...
public class EmprendedorTests
{
    ...
    {
        Habilitacion h1 = new Habilitacion("Habilitacion Comercial", "Habilitacion Comercial", "Intendencia Municipal De Montevideo (IMM)", new DateTime(2021, 10, 10), new DateTime(2026, 10, 10), true);
        Habilitacion h2 = new Habilitacion("Habilitacion Comercial 2", "Habilitacion Comercial 2 ", "Intendencia Municipal De Montevideo (IMM)", new DateTime(2021, 10, 10), new DateTime(2026, 10, 10), true);
