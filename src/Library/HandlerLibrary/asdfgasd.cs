...
namespace PII_E13.HandlerLibrary
{
    ...
    /// </summary>
    public class asdfgasd : HandlerBase
    {
        ...
        /// </summary>
        public asdfgasd(HandlerBase siguiente, string intencion) : base(siguiente, intencion)
        {
        ...
        protected override bool ResolverInterno(Sesion sesion, IMensaje mensaje, out IRespuesta respuesta)
        {
            ...
            if (infoPostulacion.OfertasDisponibles == null)
            {
                infoPostulacion.OfertasDisponibles = new List<string>();
                foreach (Oferta oferta in Sistema.Instancia.Ofertas)
                {
                    infoPostulacion.OfertasDisponibles.Add(oferta.Titulo);
                }
            }
        ...
        private class InformacionPostulacion
        {
            ...
            public List<string> OfertasDisponibles { get; set; }
